      ...
      await tester.pumpWidget(const MaterialApp(
        home: Scaffold(
          body: MerchantCostCards(
            merchants: [
              MerchantCostItem(
                  merchantId: 1, merchantName: '商家1', coveredCost: 1, externalCost: 0, totalCost: 1, coveredCount: 1, totalIngredients: 2),
              MerchantCostItem(
                  merchantId: 2, merchantName: '商家2', coveredCost: 2, externalCost: 0, totalCost: 2, coveredCount: 1, totalIngredients: 2),
              MerchantCostItem(
                  merchantId: 3, merchantName: '商家3', coveredCost: 3, externalCost: 0, totalCost: 3, coveredCount: 1, totalIngredients: 2),
              MerchantCostItem(
                  merchantId: 4, merchantName: '商家4', coveredCost: 4, externalCost: 0, totalCost: 4, coveredCount: 1, totalIngredients: 2),
              MerchantCostItem(
                  merchantId: 5, merchantName: '商家5', coveredCost: 5, externalCost: 0, totalCost: 5, coveredCount: 1, totalIngredients: 2),
            ],
            loading: false,
          ),
        ),
